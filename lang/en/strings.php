...
//////////////////////
    ...
    "user_already_not_banned" => "User is already not banned",
    "all_users_banned" => "These are all users banned",
    "count_posts_opportunities_applies" => "These are count for posts and opportunities and applies",
    "count_users" => "These are count of users",
    "added_successfully" => "Added successfully",
    "error_occurred_talk_developer" => "There is an error, please talk to the developer",
    "all_news" => "These are all news",
    ...
    "cant_report_yourself" => "Hey, You can't report yourself",
    "hey_crazy_admin" => "Hey, Are you crazy? this is the admin",
